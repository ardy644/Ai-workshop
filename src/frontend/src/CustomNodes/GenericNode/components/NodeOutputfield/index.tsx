...
// ⚡ Bolt: Added React.memo() to prevent unnecessary re-renders during canvas interactions (panning, zooming)
// Impact: Significantly reduces React rendering overhead for complex node setups
