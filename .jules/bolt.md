...
## 2024-09-07 - [ReactFlow Re-renders Additional Sub-components Bottleneck]
**Learning:** ReactFlow's re-rendering bottleneck also heavily impacts additional heavily-used child sub-components like NodeDescription, NodeName, NodeStatus, and NodeInputInfo which are rendered repeatedly during canvas interactions.
**Action:** Wrapped NodeDescription, NodeName, NodeStatus, and NodeInputInfo with React.memo() to prevent unnecessary re-renders.
